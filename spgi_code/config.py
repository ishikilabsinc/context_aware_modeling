...
# Raw SPGI word-level segment data. Update if your dataset lives elsewhere.
SPGI_DATASET_DIR = BASE_DIR.parent / 'spgi' / 'spgi_dataset'
# Pipeline intermediates and output (all under spgi_code/)
...
STAGE4_MAX_SAMPLES_PER_MEETING = 2000 # cap samples per meeting_id (e.g. 500); None = no cap
